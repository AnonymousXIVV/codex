...
function seedInitialDataIfEmpty(db) {
  ...
  if (projCount === 0) {
    const initialProjects = [
      {
        title: "Aetherial Design Systems",
        site_name: "Aetherial OS",
      ...
      {
        title: "Krypton Luxury Timepieces",
      ...
      {
        title: "Sovereign Asset Management",
        site_name: "Sovereign Private Capital",
