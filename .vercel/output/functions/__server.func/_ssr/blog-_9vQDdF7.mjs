...
import { S as require_jsx_runtime, b as useSearch, y as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { Kt as Check, Qt as BookOpen, T as Share2, Yt as Calendar, i as User, in as ArrowLeft, y as Sparkles, zt as Clock } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { g as cn } from "./router-ICi-0EwA.mjs";
import { a as NewsletterSignup, c as ScrollProgress, d as calculateReadingTime, i as Nav, l as SiteCanvas, r as Footer, s as SEO } from "./Footer-CXqLKlrJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/blog-_9vQDdF7.js
			...
			try {
				...
				if (res.ok) {
					...
					if (json.blogs && json.blogs.length > 0) {
						const found = slug ? json.blogs.find((b) => b.slug === slug || String(b.id) === slug) : json.blogs[0];
						if (found) {
							let parsedTags = [
								"Architecture",
								"Engineering",
							...
							setCurrentPost({
								...
								coverImage: found.cover_image || void 0,
